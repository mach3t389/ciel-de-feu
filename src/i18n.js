...
const LANGS = {
  fr: {
    ...
    mobileDecoyDesc: 'Larguer un leurre (≡ G)',
    ...
    ctrlLines: [
      ...
      'G — Déployer un leurre (manette : LB court)',
    ...
    slotDesc_cell_renforcee: "Structure de l'appareil : résistance mécanique et aux collisions, poids global.",
    slotDesc_siege_blinde  : "Cockpit blindé : protège le pilote et absorbe une part des dégâts reçus.",
  ...
  en: {
    ...
    mobileDecoyDesc: 'Deploy a decoy (≡ G)',
    ...
    ctrlLines: [
      ...
      'G — Deploy decoy (gamepad: LB short)',
    ...
    slotDesc_cell_renforcee: 'Aircraft structure: mechanical resistance and collision durability, overall weight.',
    slotDesc_siege_blinde  : 'Armoured cockpit: protects the pilot and absorbs some incoming damage.',
...
const CTRL_KB_LANGS = {
  fr: {
    ...
    noteTurbo :'★  TURBOCOMPRESSEUR — Bonus passif si installé · Aucune touche requise',
  ...
  en: {
    ...
    noteTurbo :'★  TURBOCHARGER — Passive bonus if installed · No key required',
...
const EQUIP_LABELS_EN = {
  ...
  'TURBOCOMPRESSEUR':'TURBOCHARGER', 'FILTRE ALTITUDE':'ALTITUDE FILTER',
