...
const LANGS = {
  fr: {
    ...
    enemyCountEstimate: '≈ {n} ennemis avec {p} joueur(s) — difficulté croissante en coop',
    ...
    returnLobbyBtn: '⟲  RETOUR AU LOBBY',
    ...
    adDescEcm         : 'Brouillage radar',
    adDescShieldFront : 'Bouclier frontal',
    adDescShieldRear  : 'Bouclier arrière',
    adDescShield360   : 'Protection totale',
    adDescLeurres     : 'Leurres thermiques',
    villageSteMere  : 'Ste-Mère',
    villageArro     : 'Arromanches',
    villageBayeux   : 'Bayeux',
    villageFalaise  : 'Falaise',
    ranking         : 'CLASSEMENT',
    roundLabel      : 'MANCHE',
    ...
    matchVictoryTitle: 'VICTOIRE',
    matchDefeatTitle : 'DÉFAITE',
    matchDrawTitle   : 'ÉGALITÉ',
    matchEndedSub    : '✦  PARTIE TERMINÉE  ✦',
    ...
    landingWarn         : 'RÉDUIRE VITESSE — MAX 50 KM/H',
    ...
    prestigeViewSub        : 'Atteignez le niveau 50 pour déclencher un prestige et débloquer un avantage permanent.',
    prestigeMaxSub         : 'Prestige maximum atteint. Tous les avantages permanents sont débloqués.',
    ...
    prestigeObtained       : '✓ OBTENU',
    prestigeUpcoming       : 'À VENIR',
  ...
  en: {
    ...
    enemyCountEstimate: '≈ {n} enemies with {p} player(s) — scales up in co-op',
    ...
    endGameBtn    : '✗  END GAME',
    returnLobbyBtn: '⟲  RETURN TO LOBBY',
    ...
    adDescEcm         : 'Radar jamming',
    adDescShieldFront : 'Front shield',
    adDescShieldRear  : 'Rear shield',
    adDescShield360   : 'Full protection',
    adDescLeurres     : 'Thermal decoys',
    villageSteMere  : 'Ste-Mère',
    villageArro     : 'Arromanches',
    villageBayeux   : 'Bayeux',
    villageFalaise  : 'Falaise',
    ...
    matchVictoryTitle: 'VICTORY',
    matchDefeatTitle : 'DEFEAT',
    matchDrawTitle   : 'DRAW',
    matchEndedSub    : '✦  MATCH ENDED  ✦',
    ...
    landingWarn         : 'REDUCE SPEED — MAX 50 KM/H',
    ...
    prestigeViewSub        : 'Reach level 50 to trigger a prestige and unlock a permanent advantage.',
    prestigeMaxSub         : 'Maximum prestige reached. All permanent advantages are unlocked.',
    ...
    prestigeObtained       : '✓ OBTAINED',
    prestigeUpcoming       : 'UPCOMING',
