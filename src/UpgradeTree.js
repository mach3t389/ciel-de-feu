...
export const UPGRADES = {
  ...
  tank2: {
    ...
    levelReq:32, cost:2000, requires:'tank1',
    stats: { fuel:+20, speed:-3, maneuverability:-4, logistics:-7, load:+15 },
  ...
  engine_sv1: {
    id:'engine_sv1', cat:'aviation', name:'Moteur Haute Vitesse I',
    levelReq:10, cost:2500, requires:null,
    stats: { speed:+15, accel:+3, maneuverability:-3, fuel:-10, logistics:-5 },
    desc:'Moteur optimisé pour la vitesse de pointe : cylindrée élevée, peu de couple bas régime.',
  },
  engine_sv2: {
    id:'engine_sv2', cat:'aviation', name:'Moteur Haute Vitesse II',
    levelReq:38, cost:6000, requires:'engine_sv1',
    stats: { speed:+10, accel:+2, maneuverability:-2, fuel:-8, logistics:-5 },
    desc:'Version course : vitesse de pointe maximale, forte consommation.',
  },
  engine_hp1: {
    id:'engine_hp1', cat:'aviation', name:'Moteur Haute Puissance I',
    levelReq:14, cost:2500, requires:null,
    stats: { speed:+5, accel:+15, maneuverability:+3, fuel:-8, logistics:-5 },
    desc:'Moteur à fort couple : reprise immédiate et maniabilité accrue, vitesse de pointe modérée.',
  },
  engine_hp2: {
    id:'engine_hp2', cat:'aviation', name:'Moteur Haute Puissance II',
    levelReq:44, cost:6000, requires:'engine_hp1',
    stats: { speed:+3, accel:+10, maneuverability:+2, fuel:-6, logistics:-5 },
    desc:'Version combat : accélération maximale, idéal pour les dogfights serrés.',
  },
  wings1: {
  ...
  wings2: {
    ...
    levelReq:32, cost:4000, requires:'wings1',
    stats: { maneuverability:+10, defense:-5, fuel:+5 },
  ...
  firerate: {
    ...
    levelReq:42, cost:3500, requires:null,
  ...
  missile_aa: {
    ...
    levelReq:12, cost:10000, requires:null,
  ...
  missile_imp1: {
    ...
    levelReq:26, cost:4000, requires:'missile_aa',
  ...
  missile_imp2: {
    ...
    levelReq:34, cost:6000, requires:'missile_imp1',
    stats: { weaponry:+5, maneuverability:-3, speed:-2, fuel:-3, logistics:-3 },
  ...
  dual_missile: {
    ...
    levelReq:30, cost:5000, requires:'missile_imp1',
  ...
  missile_ag: {
    ...
    levelReq:18, cost:6000, requires:null,
    stats: { weaponry:+15, maneuverability:-8, speed:-8, fuel:-18, logistics:-12, load:+30 },
  ...
  armor2: {
    ...
    levelReq:20, cost:3500, requires:'armor1',
  ...
  armor3: {
    ...
    levelReq:38, cost:8000, requires:'armor2',
  ...
  resist_aa: {
    ...
    levelReq:23, cost:6000, requires:null,
  ...
  resist_plane: {
    ...
    levelReq:38, cost:7000, requires:null,
  ...
  repair2: {
    ...
    levelReq:26, cost:3500, requires:'repair1',
    stats: { logistics:+10, speed:-2 },
  ...
  rearm1: {
    ...
    levelReq:18, cost:2000, requires:null,
  ...
  rearm2: {
    ...
    levelReq:36, cost:4000, requires:'rearm1',
    stats: { logistics:+10, maneuverability:-2 },
  ...
  refuel1: {
    ...
    levelReq:28, cost:2500, requires:null,
    stats: { logistics:+10, maneuverability:-2 },
  ...
  refuel2: {
    ...
    levelReq:46, cost:5000, requires:'refuel1',
    stats: { logistics:+10, maneuverability:-2 },
  ...
  decoy2: {
    ...
    levelReq:40, cost:7000, requires:'decoy1',
  ...
  decoy3: {
    ...
    levelReq:52, cost:9000, requires:'decoy2',
    stats: { maneuverability:-2, fuel:-3, logistics:-3 },
  ...
  turbo: {
    ...
    levelReq:36, cost:6000, requires:null,
    stats: { speed:+18, accel:+15, maneuverability:-3, fuel:-10, logistics:-5 },
    desc:'Suralimentation permanente : vitesse de pointe et accélération nettement accrues, consommation augmentée.',
  },
  alt_filter: {
    id:'alt_filter', cat:'propulsion', name:'Filtre altitude',
    levelReq:14, cost:3000, requires:null,
    stats: { speed:+5, maneuverability:+5, fuel:-3, logistics:-3 },
    desc:'Filtre à air haute altitude : performances maintenues au-delà de 500m. Entretien et consommation légèrement accrus.',
  },
  calibre_sup: {
    id:'calibre_sup', cat:'armement', name:'Gros calibre',
    levelReq:20, cost:4000, requires:null,
  ...
  missile_ag2: {
    ...
    levelReq:32, cost:5000, requires:'missile_ag',
  ...
  missile_ag3: {
    ...
    levelReq:40, cost:6000, requires:'missile_ag2',
    stats: { weaponry:+5, speed:-4, maneuverability:-4, fuel:-5, logistics:-5 },
  ...
  missile_dmg1: {
    ...
    levelReq:10, cost:3000, requires:null,
  ...
  missile_dmg2: {
    ...
    levelReq:22, cost:7000, requires:'missile_dmg1',
    stats: { weaponry:+5, logistics:-3 },
  ...
  missile_dmg3: {
    ...
    levelReq:36, cost:15000, requires:'missile_dmg2',
  ...
  tracking1: {
    ...
    levelReq:24, cost:5000, requires:'missile_aa',
  ...
  tracking2: {
    ...
    levelReq:34, cost:8000, requires:'tracking1',
  ...
  tracking3: {
    ...
    levelReq:42, cost:14000, requires:'tracking2',
  ...
  lock_speed1: {
    ...
    levelReq:16, cost:3500, requires:'missile_aa',
  ...
  lock_speed2: {
    ...
    levelReq:30, cost:6500, requires:'lock_speed1',
  ...
  tail_cam: {
    ...
    levelReq:30, cost:4000, requires:null,
    stats: { logistics:+5 },
  ...
  ecm1: {
    ...
    levelReq:30, cost:8000, requires:null,
  ...
  shield_front2: {
    ...
    levelReq:40, cost:4000, requires:'shield_front1',
  ...
  shield_front3: {
    ...
    levelReq:50, cost:6000, requires:'shield_front2',
  ...
  shield_full2: {
    ...
    levelReq:48, cost:6000, requires:'shield_full1',
  ...
  shield_full3: {
    ...
    levelReq:55, cost:8000, requires:'shield_full2',
...
export const EQUIPMENT_CATALOG = {
  propulsion: { label:'PROPULSION', icon:'✈', slots:{
    tank:   { label:'RÉSERVOIR', options:[
      ...
      { id:'agrandi1',  name:'Agrandi I',        icon:'◑',  levelReq:5,  pros:['Carburant +20%'],        cons:['Vitesse −3%','Maniab. −4%','Logistique −7%'],        upgrades:['tank1'] },
      { id:'agrandi2',  name:'Agrandi II',       icon:'●',  levelReq:32, pros:['Carburant +40%'],        cons:['Vitesse −6%','Maniab. −8%','Logistique −14%'],       upgrades:['tank1','tank2'] },
    ]},
    ...
    wings:  { label:'AILES', options:[
      { id:'standard',   name:'Standard',        icon:'—',  levelReq:1,  pros:[],                              cons:[],              upgrades:[] },
      { id:'allegees1',  name:'Allégées I',      icon:'↑',  levelReq:12, pros:['Maniab. +10%','Carburant +5%'],  cons:['Déf. −5%'],  upgrades:['wings1'] },
      { id:'allegees2',  name:'Allégées II',     icon:'⬆',  levelReq:32, pros:['Maniab. +20%','Carburant +10%'], cons:['Déf. −10%'], upgrades:['wings1','wings2'] },
    ]},
  ...
  canons: { label:'CANONS', icon:'⌖', slots:{
    ammo:     { label:'MUNITIONS', options:[
      ...
      { id:'200',  name:'200 rds',  icon:'▪▪',  levelReq:5,  pros:['Munitions ×2'], cons:['Maniab. −3%','Logistique −5%'],            upgrades:['mag1'] },
      { id:'300',  name:'300 rds',  icon:'▪▪▪', levelReq:30, pros:['Munitions ×3'], cons:['Maniab. −6%','Logistique −10%'],           upgrades:['mag1','mag2'] },
    ]},
    ap:       { label:'TYPE MUNITIONS', options:[
      { id:'standard',    name:'Standard',       icon:'○',  levelReq:1,  pros:[],                cons:[],                                                   upgrades:[] },
      { id:'perforantes', name:'Perforantes',    icon:'◆',  levelReq:13, pros:['Armement +15%'], cons:['Vitesse −2%','Carburant −2%','Logistique −5%'],     upgrades:['ap'] },
    ]},
    calibre:  { label:'CALIBRE', options:[
      { id:'standard',    name:'Standard',       icon:'○',  levelReq:1,  pros:[],                cons:[],                                                    upgrades:[] },
      { id:'superieur',   name:'Supérieur',      icon:'◈',  levelReq:26, pros:['Armement +20%'], cons:['Cadence −15%','Maniab. −2%','Carburant −3%'],      upgrades:['calibre_sup'] },
    ]},
  ...
  defense: { label:'DÉFENSE', icon:'⬡', slots:{
    ...
    active_defense: { label:'DÉFENSE ACTIVE', options:[
      ...
      { id:'ecm_2',         name:'ECM II',          icon:'⊡',  levelReq:44, pros:['Brouille lock missile','5s / cd 16s'],  cons:['Carburant −10%','Logistique −8%'],                     upgrades:['ecm1','ecm2'] },
      { id:'ecm_3',         name:'ECM III',         icon:'⊡',  levelReq:54, pros:['Brouille lock missile','8s / cd 12s'],  cons:['Carburant −14%','Logistique −11%'],                    upgrades:['ecm1','ecm2','ecm3'] },
      { id:'shield_front_1',name:'Boucl. Av. I',    icon:'◭',  levelReq:26, pros:['−30% dégâts frontaux','5s / cd 25s'],  cons:['Vitesse −4%','Maniab. −5%'],                           upgrades:['shield_front1'] },
      { id:'shield_front_2',name:'Boucl. Av. II',   icon:'◭',  levelReq:40, pros:['−45% dégâts frontaux','6s / cd 20s'],  cons:['Vitesse −6%','Maniab. −7%'],                           upgrades:['shield_front1','shield_front2'] },
      { id:'shield_front_3',name:'Boucl. Av. III',  icon:'◭',  levelReq:50, pros:['−60% dégâts frontaux','8s / cd 15s'],  cons:['Vitesse −9%','Maniab. −10%'],                          upgrades:['shield_front1','shield_front2','shield_front3'] },
      { id:'shield_rear_1', name:'Boucl. Ar. I',    icon:'◬',  levelReq:26, pros:['−30% dégâts arrière','5s / cd 25s'],   cons:['Vitesse −4%','Maniab. −5%'],                           upgrades:['shield_rear1'] },
      { id:'shield_rear_2', name:'Boucl. Ar. II',   icon:'◬',  levelReq:40, pros:['−45% dégâts arrière','6s / cd 20s'],   cons:['Vitesse −6%','Maniab. −7%'],                           upgrades:['shield_rear1','shield_rear2'] },
      { id:'shield_rear_3', name:'Boucl. Ar. III',  icon:'◬',  levelReq:50, pros:['−60% dégâts arrière','8s / cd 15s'],   cons:['Vitesse −9%','Maniab. −10%'],                          upgrades:['shield_rear1','shield_rear2','shield_rear3'] },
      { id:'shield_full_1', name:'Boucl. 360° I',   icon:'⊙',  levelReq:35, pros:['−20% tous dégâts','4s / cd 30s'],      cons:['Vitesse −12%','Maniab. −15%','Carburant −5%'],         upgrades:['shield_full1'] },
  ...
  logistics: { label:'LOGISTIQUE', icon:'⚙', slots:{
    ...
    refuel:      { label:'RAVITAILLEMENT', options:[
      { id:'standard', name:'Standard',  icon:'○',  levelReq:1,  pros:[],                                          cons:[],                      upgrades:[] },
      { id:'rapide1',  name:'Rapide I',  icon:'◑',  levelReq:28, pros:['Ravitaillement −20%','Logistique +10%'], cons:['Maniab. −2%'],         upgrades:['refuel1'] },
  ...
  equipements: { label:'ÉQUIPEMENTS', icon:'◈', slots:{
    ...
    tail_cam: { label:'CAMÉRA ARRIÈRE', options:[
      { id:'none',       name:'Aucune',   icon:'○',  levelReq:1,  pros:[],                                            cons:[],  upgrades:[] },
      { id:'installed',  name:'Installée',icon:'⊙',  levelReq:30, pros:['Alerte ennemis dans le dos','Logistique +5%'], cons:[], upgrades:['tail_cam'] },
    ]},
  }},
};
...
export const OPTION_COSTS = {
  ...
  'tank:agrandi1'          : 1000,
  'tank:agrandi2'          : 3000,
  'engine:vitesse1'        : 2500,
  'engine:vitesse2'        : 6000,
  'engine:puissance1'      : 2500,
  'engine:puissance2'      : 6000,
