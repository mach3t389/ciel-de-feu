...
export const UPGRADES = {
  ...
  tank2: {
    ...
    levelReq:13, cost:2000, requires:'tank1',
    stats: { fuel:+20, speed:-3, maneuverability:-4, logistics:-7, load:+15 },
  ...
  engine_sv1: {
    ...
    levelReq:8, cost:2500, requires:null,
  ...
  engine_sv2: {
    ...
    levelReq:15, cost:6000, requires:'engine_sv1',
  ...
  engine_hp2: {
    ...
    levelReq:15, cost:6000, requires:'engine_hp1',
  ...
  dual_missile: {
    ...
    levelReq:35, cost:5000, requires:'missile_imp1',
...
export const EQUIPMENT_CATALOG = {
  propulsion: { label:'PROPULSION', icon:'✈', slots:{
    tank:   { label:'RÉSERVOIR', options:[
      ...
      { id:'agrandi2',  name:'Agrandi II',       icon:'●',  levelReq:13, pros:['Carburant +40%'],        cons:['Vitesse −6%','Maniab. −8%','Logistique −14%'],       upgrades:['tank1','tank2'] },
    ]},
    engine: { label:'MOTEUR', options:[
      { id:'standard',   name:'Standard',          icon:'⚙',  levelReq:1,  pros:[],                                     cons:[],                                                         upgrades:[] },
      { id:'vitesse1',   name:'Haute Vitesse I',   icon:'▶',  levelReq:8,  pros:['Vitesse +15%','Accél. +3%'],          cons:['Maniab. −3%','Carburant −10%','Logistique −5%'],           upgrades:['engine_sv1'] },
      { id:'vitesse2',   name:'Haute Vitesse II',  icon:'▶▶', levelReq:15, pros:['Vitesse +25%','Accél. +5%'],          cons:['Maniab. −5%','Carburant −18%','Logistique −10%'],          upgrades:['engine_sv1','engine_sv2'] },
      { id:'puissance1', name:'Haute Puissance I', icon:'◈',  levelReq:8,  pros:['Accél. +15%','Maniab. +3%','Vitesse +5%'], cons:['Carburant −8%','Logistique −5%'],                   upgrades:['engine_hp1'] },
      { id:'puissance2', name:'Haute Puissance II',icon:'◉',  levelReq:15, pros:['Accél. +25%','Maniab. +5%','Vitesse +8%'], cons:['Carburant −14%','Logistique −10%'],                  upgrades:['engine_hp1','engine_hp2'] },
    ]},
    wings:  { label:'AILES', options:[
      ...
      { id:'allegees2',  name:'Allégées II',     icon:'⬆',  levelReq:22, pros:['Maniab. +20%','Carburant +10%'], cons:['Déf. −10%'], upgrades:['wings1','wings2'] },
    ]},
    turbo:  { label:'TURBO', options:[
      { id:'none',       name:'Aucun',           icon:'○',  levelReq:1,  pros:[],                                cons:[],                                                  upgrades:[] },
      { id:'installed',  name:'Installé',        icon:'✺',  levelReq:20, pros:['Vitesse +18%','Accél. +15%'], cons:['Maniab. −3%','Carburant −10%','Logistique −5%'],    upgrades:['turbo'] },
    ]},
  ...
  canons: { label:'CANONS', icon:'⌖', slots:{
    ammo:     { label:'MUNITIONS', options:[
      ...
      { id:'300',  name:'300 rds',  icon:'▪▪▪', levelReq:12, pros:['Munitions ×3'], cons:['Maniab. −6%','Logistique −10%'],           upgrades:['mag1','mag2'] },
    ]},
    ap:       { label:'TYPE MUNITIONS', options:[
      { id:'standard',    name:'Standard',       icon:'○',  levelReq:1,  pros:[],                cons:[],                                                   upgrades:[] },
      { id:'perforantes', name:'Perforantes',    icon:'◆',  levelReq:10, pros:['Armement +15%'], cons:['Vitesse −2%','Carburant −2%','Logistique −5%'],     upgrades:['ap'] },
    ]},
    ...
    firerate: { label:'CADENCE', options:[
      { id:'standard',  name:'Standard',         icon:'○',  levelReq:1,  pros:[],               cons:[],                                                      upgrades:[] },
      { id:'ameliore',  name:'Améliorée',        icon:'≫',  levelReq:15, pros:['Cadence +20%'], cons:['Maniab. −3%','Carburant −5%','Logistique −6%'],      upgrades:['firerate'] },
    ]},
  }},
  missiles_cat: { label:'MISSILES', icon:'⊕', slots:{
    ...
    missiles_ag: { label:'MISSILES AS', options:[
      { id:'none',  name:'Aucun',   icon:'○',  levelReq:1,  pros:[],                cons:[],                                                                        upgrades:[] },
      { id:'2ag',   name:'×2 AS',   icon:'▽',  levelReq:25, pros:['Armement +15%'], cons:['Vitesse −8%','Maniab. −8%','Carburant −18%','Logistique −12%'],          upgrades:['missile_ag'] },
      { id:'4ag',   name:'×4 AS',   icon:'▽',  levelReq:35, pros:['Armement +20%'], cons:['Vitesse −12%','Maniab. −12%','Carburant −23%','Logistique −17%'],        upgrades:['missile_ag','missile_ag2'] },
      { id:'6ag',   name:'×6 AS',   icon:'▽',  levelReq:45, pros:['Armement +25%'], cons:['Vitesse −16%','Maniab. −16%','Carburant −28%','Logistique −22%'],        upgrades:['missile_ag','missile_ag2','missile_ag3'] },
    ]},
  ...
  defense: { label:'DÉFENSE', icon:'⬡', slots:{
    ...
    armor:  { label:'BLINDAGE', options:[
      ...
      { id:'moyen', name:'Moyen',  icon:'◑',  levelReq:15, pros:['+35 HP'],  cons:['Vitesse −7%','Maniab. −3%','Carburant −11%','Logistique −8%'],    upgrades:['armor1','armor2'] },
      { id:'lourd', name:'Lourd',  icon:'●',  levelReq:28, pros:['+65 HP'],  cons:['Vitesse −15%','Maniab. −12%','Carburant −23%','Logistique −18%'], upgrades:['armor1','armor2','armor3'] },
    ]},
    resist: { label:'RÉSISTANCE', options:[
      { id:'none',    name:'Aucune',         icon:'○',  levelReq:1,  pros:[],                          cons:[],                                               upgrades:[] },
      { id:'turrets', name:'Anti-Tourelles', icon:'⬡',  levelReq:20, pros:['−15% dégâts (tourelles)'], cons:['Carburant −3%','Logistique −4%'],               upgrades:['resist_aa'] },
      { id:'planes',  name:'Anti-Avions',    icon:'✈',  levelReq:30, pros:['−15% dégâts (avions)'],    cons:['Vitesse −2%','Carburant −4%','Logistique −5%'], upgrades:['resist_plane'] },
    ]},
    ...
    siege_blinde: { label:'COCKPIT', options:[
      { id:'none',     name:'Standard',      icon:'○',  levelReq:1,  pros:[],                                     cons:[],                                            upgrades:[] },
      { id:'blinde',   name:'Blindé',        icon:'◈',  levelReq:18, pros:['Déf. +10%','+8 HP','Dégâts −10%'], cons:['Vitesse −2%','Maniab. −3%','Carburant −3%'], upgrades:['siege_blinde'] },
    ]},
  }},
